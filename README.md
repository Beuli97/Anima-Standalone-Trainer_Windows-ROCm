Not Uploaded yet. Still testing.
[IMPORTANT]
That Fork is mostly Vibe Coded. Runs on my system without any problems.
Stripped away a lot of stuff that isnt compatible or required for ROCm and fixed a few things.
Using a 7900XT lora Training with 2.5s/it
...
Because i have 2 grafic chips the default HIP Device is set to 1 (set HIP_VISIBLE_DEVICES=1)
If you have 1 device change to 0 if you have more Change to the device you want to use.
For everything else check Original Repo.
